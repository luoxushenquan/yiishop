...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <dl>
                <dt><?=$v->username.'&nbsp'.$v->cmbprovince.'&nbsp'.$v->cmbcity.'&nbsp'.$v->cmbarea.'&nbsp'.$v->content.'&nbsp'.$v->tel?></dt>
                <dd>
                    <a href="">修改</a>
        ...
        <div class="address_bd mt10">
            <h4>新增收货地址</h4>
            <form action="<?=\yii\helpers\Url::to(['address/add'])?>" id="fm" name="address_form" method="post">
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" name="content" class="txt address"  />
                    </li>
                    <li>
...
<!--                    <li>-->
<!--                        <label for="">&nbsp;</label>-->
<!--                        <input type="checkbox" name="checkbox" class="check" />设为默认地址-->
<!--                    </li>-->
                    <li>
                        <label for="">&nbsp;</label>
