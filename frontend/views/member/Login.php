...
<div class="login w990 bc mt10">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form action="<?=\yii\helpers\Url::to(['member/login'])?>" method="post" id="login_form">
                <ul>
                    <li>
                        <label for="">用户名：</label>
...
<!--                        <span>看不清？<a href="javascript:;" id="change_captcha">换一张</a></span>-->
        ...
        <div class="guide fl">
            <h3>还不是尊贵的心悦三</h3>
            <p>现在注册立享充钱特权保证冲的快..快来加入吧</p>

            <a href="<?=\yii\helpers\Url::to(['member/add'])?>" class="reg_btn">注册成为会员 >></a>
        </div>
