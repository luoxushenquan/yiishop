...
<!--                            相册里面的图片-->
                            ...
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="<?=Yii::$app->params['backend_domain'].$v->path?>"></a>
                            </li>
                            <?php endforeach; ?>
...
<!--                --><?php //foreach($model2 as $v2): $id=$v2->id ?>
                ...
                <ul>
                    ...
                    <li><span>上架时间：</span><?=date('Y-m-d H:i:s',$model2->create_time)?></li>
