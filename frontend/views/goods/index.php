    ...
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
              ...
              ?>
                    <li id="user_info">您好，欢迎来到西边太阳！[<a href="<?=\yii\helpers\Url::to(['member/login'])?>">登录</a>] [<a href="<?=\yii\helpers\Url::to(['member/add'])?>">免费注册</a>] </li>
                    <?php
                }else{
                    ?>
...
<script>
    //通过ajax更新
    $.getJSON("<?=\yii\helpers\Url::to(['user-status'])?>", function (json) {
        if(json.isLogin){
            $("#user_info").html('欢迎'+json.username+'])
        }
    });
</script>
